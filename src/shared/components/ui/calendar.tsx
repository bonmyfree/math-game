...
// ─── Sub-components (defined outside to avoid re-render issues) ───────────────

interface CalendarRootProps extends React.ComponentPropsWithoutRef<'div'> {
...
function Calendar({
  ...
  const contextValue = React.useMemo<CalendarContextValue>(() => ({ locale }), [locale])
